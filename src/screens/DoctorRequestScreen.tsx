...
interface DoctorRequestScreenProps {
  onBackToLanding: () => void;
  onEnterDoctorDemo?: () => void;
  onEnterDoctorDashboard?: () => void;
}

export const DoctorRequestScreen: React.FC<DoctorRequestScreenProps> = ({
  onBackToLanding,
}) => {
          ...
          <div className="bg-white border-2 border-[#00A86B] rounded-3xl p-8 text-center space-y-6 shadow-md animate-fade-in">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-[#406354] pt-2">
                Après validation de votre demande, vos identifiants d'accès vous seront envoyés.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Ex : Médecin généraliste, Pédiatre..."
                  className="w-full min-h-[56px] px-4 rounded-xl border border-[#C8E6D5] text-base focus:border-[#00A86B] outline-none"
                />
              </div>
